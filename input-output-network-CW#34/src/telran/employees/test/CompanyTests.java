...
class CompanyTests {
	...
	void testGetDepartmentSalaryDistribution() {
		// TODO
		List<DepartmentSalary> salaries = company.getDepartmentSalaryDistribution();
	...
	void testGetEmployeesByDepartment() {
		// TODO
		List<Employee> itEmployees = company.getEmployeesByDepartment(DEP1);
	...
	void testGetEmployeesBySalary() {
		// TODO
		List<Employee> highPaidEmployees = company.getEmployeesBySalary(9000, 11000);
	...
	void testGetEmployeesByAge() {
		// TODO
		List<Employee> youngEmployees = company.getEmployeesByAge(20, 25);
		// youngEmployees.forEach(e -> System.out.println(e.name() + " : " +
		// ((CompanyImpl)company).getAge(e.birthDate())));
		// youngEmployees.forEach(System.out::println);
		assertEquals(3, youngEmployees.size());
	...
	void testUpdateDepartment() {
		// TODO
		Employee updatedEmployee = company.updateDepartment(ID1, "Finance");
		assertNotNull(updatedEmployee);
		assertEquals("Finance", updatedEmployee.department());
	}
